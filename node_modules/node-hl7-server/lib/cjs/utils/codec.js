...
class MLLPCodec {
    ...
    sendMessage(socket, message, encoding) {
        const messageBuffer = Buffer.concat([
            constants_js_1.PROTOCOL_MLLP_HEADER,
            Buffer.from(message, encoding),
            constants_js_1.PROTOCOL_MLLP_END,
            constants_js_1.PROTOCOL_MLLP_FOOTER,
        ]);
        socket?.write(messageBuffer);
    }
}
exports.MLLPCodec = MLLPCodec;

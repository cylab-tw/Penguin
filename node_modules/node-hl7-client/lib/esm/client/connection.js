...
import { createDeferred, expBackoff, isBatch, } from "../utils/utils.js";
        ...
        const checkSend = async (_message) => {
            while (true) {
                ...
                try {
                    ...
                    else if (this._readyState === ReadyState.CONNECTED &&
                        this._opt.waitAck &&

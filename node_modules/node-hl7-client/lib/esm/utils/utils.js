 ...
 */
export const assertNumber = (props, name, min, max) => {
 ...
 * @param length
 */
export const createHL7Date = (date, length) => {
    switch (length) {
        case "8":
 ...
 * @param value
 */
export const decodeHexString = (value) => {
 ...
 * @param exp
 */
export const expBackoff = (step, high, attempts, exp = 2) => {
 ...
 * @param value
 */
export const isHL7Number = (value) => {
 ...
 * @param value
 */
export const isHL7String = (value) => typeof value === "string";
/**
 ...
 * @param z
 */
export const padHL7Date = (n, width, z = "0") => {
    const s = n.toString();
 ...
 * @param segments
 */
export const split = (data, segments = []) => {
    const getSegIndex = [
 ...
 * @param list
 */
const getSegIndexes = (names, data, list = []) => {
 ...
 * @param noUncaught
 */
export const createDeferred = (noUncaught) => {
    const dfd = {};

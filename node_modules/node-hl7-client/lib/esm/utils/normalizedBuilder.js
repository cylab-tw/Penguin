...
export function normalizedClientMessageBuilderOptions(raw) {
    const props = {
    ...
    if (props.text === "") {
        ...
        const plan = new ParserPlan(props.text.slice(3, 8));
        props.parsing = true;
...
export function normalizedClientBatchBuilderOptions(raw) {
    const props = {
        ...DEFAULT_CLIENT_BUILDER_OPTS,
        ...raw,
    };
...
export function normalizedClientFileBuilderOptions(raw) {
    const props = {
    ...
    if (typeof props.fullFilePath !== "undefined" &&
    ...
    else if (typeof props.fullFilePath === "undefined" &&
        typeof props.fileBuffer !== "undefined") {
